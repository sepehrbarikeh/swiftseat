                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.ReserveSeatRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "handlers.ReserveSeatRequest": {
            ...
            "properties": {
                ...
                "seat_number": {
                    "description": "🚀 یکپارچه‌سازی با ساختار جدید",
                    "type": "string"
                }
            }
        },
